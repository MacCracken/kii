...
| ADR | Status | Subject |
|---|---|---|
| [0001](0001-png-decoder-in-repo.md) | Superseded by [0006](0006-adopt-chitra-decoder.md) | PNG decoder lives in-repo (not as a substrate library) until a second consumer surfaces |
